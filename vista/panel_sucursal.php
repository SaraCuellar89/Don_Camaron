        ...
        <div class="card shadow p-4">
            ...
            <form action="../controlador/acciones_sucursal.php?accion=crear" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="total_mesas" placeholder="Ingrese el total de las mesas" name="total_mesas" required>
                </div>
                <div class="mb-3">
                    <label for="mesas_disponibles" class="form-label">Mesas Disponibles:</label>
                    <input type="number" class="form-control" id="mesas_disponibles" placeholder="Ingrese la cantidad de mesas disponibles" name="mesas_disponibles" required>
                </div>
